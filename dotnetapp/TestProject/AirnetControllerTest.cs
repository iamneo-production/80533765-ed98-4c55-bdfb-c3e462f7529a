...
            // Send an HTTP GET request to the API endpoint.
 ...
 HttpResponseMessage response = await _httpClient.GetAsync("user/getReview");
...
            // Send an HTTP GET request to the API endpoint.
 ...
 HttpResponseMessage response = await _httpClient.GetAsync("admin/getAllPlan");
...
            // Send an HTTP GET request to the API endpoint.
 ...
 HttpResponseMessage response = await _httpClient.GetAsync("user/getRecharge");
